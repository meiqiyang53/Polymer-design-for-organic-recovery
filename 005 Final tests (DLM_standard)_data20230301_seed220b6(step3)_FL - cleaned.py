...
train00 = pd.read_csv('Preprocessed train (data20230301)_DLM220_0.2b6_FL.csv')
test00 = pd.read_csv('Preprocessed test (data20230301)_DLM220_0.2b6_FL.csv')
...
x_traina = traina.drop(columns=['Total_flux'])
y_train0 = traina['Total_flux']

x_testa = testa.drop(columns=['Total_flux'])
y_test0 = testa['Total_flux']


y_train1 = 10**(y_train0)
y_test1 = 10**(y_test0)
# y_train1 = np.log10(y_train0)
# y_test1 = np.log10(y_test0)
...
model = LGBMRegressor(n_estimators=400, max_depth=12, min_child_samples=5, learning_rate=0.05,
                      reg_lambda=3, feature_fraction=0.4, num_leaves=50)
...
# train_fn.to_csv('Final train (data20230301)_DLM220_0.2b6_filled_lgm_FL_normalized.csv', index=False)
# test_fn.to_csv('Final test (data20230301)_DLM220_0.2b6_filled_lgm_FL_normalized.csv', index=False)
...
# train_fn0.to_csv('Final train (data20230301)_DLM220_0.2b6_filled_lgm_FL.csv', index=False)
# test_fn0.to_csv('Final test (data20230301)_DLM220_0.2b6_filled_lgm_FL.csv', index=False)
...
# train_fn1.to_csv('Final train (data20230301)_DLM220_0.2b6_filled_lgm_FL_NO.csv', index=False)
# test_fn1.to_csv('Final test (data20230301)_DLM220_0.2b6_filled_lgm_FL_NO.csv', index=False)
